<template>
  <div class ="container-fluid">
    ...
    <div class="col-md-12 d-flex align-items-center">
      <img :src="AppState.activeProfile.picture" alt="" class="img-fluid profile-img rounded-circle">
      <div class="bg-transparent rounded p-3 ms-3">
      <h1>{{ AppState.activeProfile.name }}</h1>
      <h3>{{ AppState.activeProfile.bio }}</h3>
      </div>
    </div>
    <div class="col-md-12">
      <div class="row justify-content-around">
        ...
        <div class="col-md-5 text-start">
            <h5>{{ AppState.activeProfile.resume }}</h5>
            <h5><i class="mdi mdi-github">{{ AppState.activeProfile.github }}</i></h5>
            <h5><i class="mdi mdi-linkedin">{{ AppState.activeProfile.linkedin }}</i></h5>
        </div>
      </div>
      </div>
    </div>
    ...
    <section class="row justify-content-center">
      <button class="col-4 btn btn-light" :disabled="!olderUrl" @click="changePage(olderUrl)">
        Older</button>
        <div class="col-2 text-center">{{ AppState.olderPageUrl }}</div>
...
export default {
    ...
    return {
      posts: computed(() => AppState.profile.posts),
